 ...
 */
export async function ukgReadyAPI(request: HttpRequest, context: InvocationContext): Promise<HttpResponseInit> {
 ...
 */
async function handleTimeEntriesRequest(
  tenantId: string,
  action: string | null,
  request: HttpRequest,
  method: string
 ...
 */
async function handleEmployeesRequest(
  tenantId: string,
  action: string | null,
  request: HttpRequest,
  method: string
  ...
  switch (action) {
    ...
    case 'schedule':
      ...
      if (scheduleStart) scheduleParams.append('startDate', scheduleStart);
      if (scheduleEnd) scheduleParams.append('endDate', scheduleEnd);
