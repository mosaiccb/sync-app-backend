...
exports.createThirdPartyAPISimple = createThirdPartyAPISimple;
exports.testParBrinkConnectionSimple = testParBrinkConnectionSimple;
exports.handleOptionsSimple = handleOptionsSimple;
 ...
 */
async function createThirdPartyAPISimple(request, context) {
    try {
        ...
        let secretName = '';
        try {
            secretName = keyVaultService_1.KeyVaultService.generateSecretName(apiConfig.tenantId || 'global', apiConfig.category || 'parbrink', Date.now());
 ...
 */
async function testParBrinkConnectionSimple(request, context) {
    try {
 ...
 */
async function handleOptionsSimple(_request, _context) {
    return {
        status: 200,
        headers: {
            'Access-Control-Allow-Origin': '*',
...
functions_1.app.http('createThirdPartyAPISimple', {
    methods: ['POST'],
    authLevel: 'anonymous',
    route: 'configurations',
    handler: createThirdPartyAPISimple
});
functions_1.app.http('testParBrinkConnectionSimple', {
    methods: ['POST'],
    authLevel: 'anonymous',
    route: 'testParBrinkConnection',
    handler: testParBrinkConnectionSimple
});
functions_1.app.http('thirdPartyAPIsOptionsSimple', {
    methods: ['OPTIONS'],
    authLevel: 'anonymous',
    route: 'configurations',
    handler: handleOptionsSimple
});
//# sourceMappingURL=thirdPartyAPISimple.js.map