 ...
 */
async function fetchTotalClockedInEmployees(accessToken, locationToken, businessDate, offsetMinutes, _timezone, context) {
    try {
 ...
 */
function parseCurrentlyWorkingEmployees(xmlData) {
    try {
        const now = new Date();
